package iSpan.animalplanet.member.mail;
...
public class JavaMail {
	...
	public void SendMail(Integer id, String account, String eMail) {
		// 建構子注入
		
		customer = eMail;
		txt = "<h2>嗨 "+ account + "!</h2>"
				+ "<h3>感謝您在 Animal Planet 上註冊了一個新帳號！"
				+ "在開始前，我們必須確定是您本人申請這隻帳號的。"
				+ "請點選底下的連結以驗證您的電子郵件地址："
				+ "<a href=http://localhost:8080/AnimalPlanet/member/successAuthPage?id="+ id +">按這裡</a>"
				+"</h3>"+ id; 
